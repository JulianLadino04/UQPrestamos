--------------------------------------------------------
-- Archivo creado  - lunes-septiembre-30-2024   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."EMPLEADO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence SEQ_ID_SOLICITUD
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_ID_SOLICITUD"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SOLICITUD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SOLICITUD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CREDENCIALES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CREDENCIALES" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."EMPLEADO" 
   (	"ID_EMPLEADO" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"SALARIO" NUMBER(12,2), 
	"ID_SUCURSAL" NUMBER, 
	"NIVEL_SISTEMA" VARCHAR2(20 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
--  DDL for Table INGRESO_SISTEMA
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."INGRESO_SISTEMA" 
   (	"ID_INGRESO" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ID_USUARIO" NUMBER, 
	"ENTRADA" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP, 
	"SALIDA" TIMESTAMP (6)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SOLICITUD" 
   (	"ID_SOLICITUD" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"FECHA_SOLICITUD" DATE, 
	"ID_EMPLEADO" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUCURSAL" 
   (	"ID_SUCURSAL" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"NOMBRE" VARCHAR2(100 BYTE), 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.AUDITORIA
SET DEFINE OFF;
REM INSERTING into SYSTEM.CARGO
SET DEFINE OFF;
Insert into SYSTEM.CARGO (NOMBRE,MONTO_MAXIMO) values ('Operario','10000000');
Insert into SYSTEM.CARGO (NOMBRE,MONTO_MAXIMO) values ('Administrativo','15000000');
Insert into SYSTEM.CARGO (NOMBRE,MONTO_MAXIMO) values ('Ejecutivo','20000000');
Insert into SYSTEM.CARGO (NOMBRE,MONTO_MAXIMO) values ('Otros','12000000');
REM INSERTING into SYSTEM.CREDENCIALES
SET DEFINE OFF;
Insert into SYSTEM.CREDENCIALES (USERNAME,PASSWORD,USUARIO) values ('nestor','0000','1104697205');
Insert into SYSTEM.CREDENCIALES (USERNAME,PASSWORD,USUARIO) values ('NFCD','0000','1104697206');
Insert into SYSTEM.CREDENCIALES (USERNAME,PASSWORD,USUARIO) values ('nfcd','0000','1104697208');
REM INSERTING into SYSTEM.EMPLEADO
SET DEFINE OFF;
Insert into SYSTEM.EMPLEADO (ID_EMPLEADO,NOMBRE,CARGO,SALARIO,ID_SUCURSAL,NIVEL_SISTEMA) values ('1104697206','Nestor Castelblanco','Administrativo','25000000','1','Principal');
REM INSERTING into SYSTEM.ESTADO
SET DEFINE OFF;
Insert into SYSTEM.ESTADO (NOMBRE) values ('APROBADA');
Insert into SYSTEM.ESTADO (NOMBRE) values ('EN ESTUDIO');
Insert into SYSTEM.ESTADO (NOMBRE) values ('PENDIENTE');
Insert into SYSTEM.ESTADO (NOMBRE) values ('REPROBADA');
...
REM INSERTING into SYSTEM.INGRESO_SISTEMA
SET DEFINE OFF;
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('3','1104697206',to_timestamp('26/09/24 09:05:08,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('26/09/24 09:05:14,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('4','1104697208',to_timestamp('26/09/24 09:09:23,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('26/09/24 09:09:34,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('5','1104697208',to_timestamp('26/09/24 09:17:47,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('26/09/24 09:18:02,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('6','1104697206',to_timestamp('27/09/24 02:55:38,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('27/09/24 02:55:48,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('1','1104697205',to_timestamp('26/09/24 10:07:43,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('26/09/24 10:08:12,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('2','1104697206',to_timestamp('26/09/24 08:57:51,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('26/09/24 08:58:02,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
Insert into SYSTEM.INGRESO_SISTEMA (ID_INGRESO,ID_USUARIO,ENTRADA,SALIDA) values ('7','1104697206',to_timestamp('29/09/24 10:13:34,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('29/09/24 10:13:55,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'));
...
SET DEFINE OFF;
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Armenia');
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Cali');
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Manizales');
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Medellin');
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Palmira');
Insert into SYSTEM.MUNICIPIO (NOMBRE) values ('Tulua');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.NIVEL
SET DEFINE OFF;
Insert into SYSTEM.NIVEL (NOMBRE) values ('Empleado');
Insert into SYSTEM.NIVEL (NOMBRE) values ('Principal');
Insert into SYSTEM.NIVEL (NOMBRE) values ('Tesoria');
...
SET DEFINE OFF;
Insert into SYSTEM.PAGO (ID_PAGO,ID_PRESTAMO,NUMERO_CUOTA,FECHA_PAGO,VALOR_PAGO,MOROSO) values ('1','8','1',to_date('21/09/24','DD/MM/RR'),'750000','Y');
REM INSERTING into SYSTEM.PERIODO
SET DEFINE OFF;
Insert into SYSTEM.PERIODO (CUOTAS,TASA_INTERES) values ('24','0,07');
Insert into SYSTEM.PERIODO (CUOTAS,TASA_INTERES) values ('36','0,075');
Insert into SYSTEM.PERIODO (CUOTAS,TASA_INTERES) values ('48','0,08');
Insert into SYSTEM.PERIODO (CUOTAS,TASA_INTERES) values ('60','0,083');
Insert into SYSTEM.PERIODO (CUOTAS,TASA_INTERES) values ('72','0,086');
REM INSERTING into SYSTEM.PRESTAMO
SET DEFINE OFF;
Insert into SYSTEM.PRESTAMO (ID_SOLICITUD,FECHA_SOLICITUD,EMPLEADO_ID,MONTO,PERIODO,ESTADO,TASA_INTERES,FECHA_DESEMBOLSO) values ('8',to_date('21/09/24','DD/MM/RR'),'1104697502','12000000','72','APROBADO','8,6',to_date('03/10/24','DD/MM/RR'));
...
SET DEFINE OFF;
Insert into SYSTEM.SOLICITUD (ID_SOLICITUD,FECHA_SOLICITUD,ID_EMPLEADO,MONTO_SOLICITADO,PERIODO_MESES,ESTADO,TASA_INTERES) values ('8',to_date('21/09/24','DD/MM/RR'),'1104697502','12000000','72','aprobada','8,6');
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.SUCURSAL
SET DEFINE OFF;
Insert into SYSTEM.SUCURSAL (ID_SUCURSAL,NOMBRE,MUNICIPIO) values ('1','Oriental','Manizales');
Insert into SYSTEM.SUCURSAL (ID_SUCURSAL,NOMBRE,MUNICIPIO) values ('2','Central','Manizales');
REM INSERTING into SYSTEM.USUARIO
SET DEFINE OFF;
Insert into SYSTEM.USUARIO (ID_USUARIO,USERNAME,PASSWORD,NIVEL,NOMBRE) values ('1104697208','nfcd','0000','Tesoreria','Nestor');
Insert into SYSTEM.USUARIO (ID_USUARIO,USERNAME,PASSWORD,NIVEL,NOMBRE) values ('1104697205','nestor','0000','Empleado','Nestor');
Insert into SYSTEM.USUARIO (ID_USUARIO,USERNAME,PASSWORD,NIVEL,NOMBRE) values ('123456789','123','123','Principal','Julian Perez');
Insert into SYSTEM.USUARIO (ID_USUARIO,USERNAME,PASSWORD,NIVEL,NOMBRE) values ('1104697206','NFCD','0000','Principal','Nestor');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008321" ON "SYSTEM"."SUCURSAL" ("ID_SUCURSAL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008327" ON "SYSTEM"."EMPLEADO" ("ID_EMPLEADO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008349" ON "SYSTEM"."PAGO" ("ID_PAGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008355" ON "SYSTEM"."USUARIO" ("ID_USUARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008362" ON "SYSTEM"."AUDITORIA" ("ID_AUDITORIA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008388" ON "SYSTEM"."SOLICITUD" ("ID_SOLICITUD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008396" ON "SYSTEM"."PRESTAMO" ("ID_SOLICITUD") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008398" ON "SYSTEM"."NIVEL" ("NOMBRE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008399" ON "SYSTEM"."CARGO" ("NOMBRE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008400" ON "SYSTEM"."PERIODO" ("CUOTAS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008401" ON "SYSTEM"."ESTADO" ("NOMBRE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008402" ON "SYSTEM"."CREDENCIALES" ("USERNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008403" ON "SYSTEM"."MUNICIPIO" ("NOMBRE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUDITORIA" MODIFY ("ID_AUDITORIA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUDITORIA" MODIFY ("ID_USUARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."AUDITORIA" ADD PRIMARY KEY ("ID_AUDITORIA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CARGO" ADD PRIMARY KEY ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CREDENCIALES" ADD PRIMARY KEY ("USERNAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLEADO" MODIFY ("SALARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLEADO" MODIFY ("ID_SUCURSAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLEADO" ADD PRIMARY KEY ("ID_EMPLEADO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."ESTADO" ADD PRIMARY KEY ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table INGRESO_SISTEMA
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."INGRESO_SISTEMA" MODIFY ("ID_INGRESO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."INGRESO_SISTEMA" MODIFY ("ID_USUARIO" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MUNICIPIO" ADD PRIMARY KEY ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."NIVEL" ADD PRIMARY KEY ("NOMBRE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("ID_PAGO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("ID_PRESTAMO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("NUMERO_CUOTA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("FECHA_PAGO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" MODIFY ("VALOR_PAGO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PAGO" ADD CHECK (moroso IN ('Y', 'N')) ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PERIODO" ADD PRIMARY KEY ("CUOTAS")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRESTAMO" MODIFY ("FECHA_SOLICITUD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESTAMO" MODIFY ("EMPLEADO_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESTAMO" MODIFY ("ESTADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESTAMO" MODIFY ("TASA_INTERES" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESTAMO" MODIFY ("FECHA_DESEMBOLSO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESTAMO" ADD CHECK (MONTO > 0) ENABLE;
  ALTER TABLE "SYSTEM"."PRESTAMO" ADD CHECK (PERIODO IN (24, 36, 48, 60, 72)) ENABLE;
  ALTER TABLE "SYSTEM"."PRESTAMO" ADD PRIMARY KEY ("ID_SOLICITUD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SOLICITUD" MODIFY ("ID_SOLICITUD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SOLICITUD" MODIFY ("FECHA_SOLICITUD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SOLICITUD" MODIFY ("ID_EMPLEADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SOLICITUD" MODIFY ("MONTO_SOLICITADO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SOLICITUD" ADD CHECK (PERIODO_MESES IN (24, 36, 48, 60, 72)) ENABLE;
  ALTER TABLE "SYSTEM"."SOLICITUD" ADD CHECK (ESTADO IN ('pendiente', 'en estudio', 'aprobada', 'reprobada')) ENABLE;
  ALTER TABLE "SYSTEM"."SOLICITUD" ADD PRIMARY KEY ("ID_SOLICITUD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SUCURSAL" MODIFY ("ID_SUCURSAL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUCURSAL" MODIFY ("NOMBRE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUCURSAL" MODIFY ("MUNICIPIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUCURSAL" ADD PRIMARY KEY ("ID_SUCURSAL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIO" MODIFY ("ID_USUARIO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USUARIO" ADD CONSTRAINT "SYS_C008352" CHECK (LENGTH(NIVEL) > 0) ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."AUDITORIA" ADD FOREIGN KEY ("ID_USUARIO")
	  REFERENCES "SYSTEM"."USUARIO" ("ID_USUARIO") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLEADO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."EMPLEADO" ADD FOREIGN KEY ("ID_SUCURSAL")
	  REFERENCES "SYSTEM"."SUCURSAL" ("ID_SUCURSAL") ENABLE;
--------------------------------------------------------
