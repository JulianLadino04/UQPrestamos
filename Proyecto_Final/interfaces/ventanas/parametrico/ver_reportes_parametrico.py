...
class ver_reportes_parametrico: 
    def __init__(self):
        self.root = ctk.CTk()
        self.root.title("Reportes Parametricos")
        self.root.geometry("750x550")
        self.root.resizable(True, True)

        ctk.CTkLabel(master=self.root, text="Vista de Reportes Parametricos", font=("Roboto", 36)).pack(pady=15)
