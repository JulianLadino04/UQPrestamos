...
class gestionar_solicitudes:
    def __init__(self):
        self.root = ctk.CTk()
        self.root.title("Solicitudes")
        self.root.geometry("750x550")
        self.root.resizable(True, True)

        ctk.CTkLabel(master=self.root, text="Vista de solicitudes del Sistema", font=("Roboto", 36)).pack(pady=15)
    ...
    def enviar_empleado(self):
        ...
        if selected_item:
            ...
            self.root.destroy() 
            ingresar_ventana_edicion_solicitud = edt.EditarSolicitudAdministradores()
    ...
    def ventana_creacion(self):
        self.root.destroy() 
        ingresar_ventana_creacion_solicitud = reg.CrearSolicitudAdministrador()
