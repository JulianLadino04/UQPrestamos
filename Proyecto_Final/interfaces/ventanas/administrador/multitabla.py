...
class multitabla:
    def __init__(self):
        self.root = ctk.CTk()
        self.root.title("Multitabla")
        self.root.geometry("750x550")
        self.root.resizable(True, True)

        ctk.CTkLabel(master=self.root, text="Vista multitabla del Sistema", font=("Roboto", 36)).pack(pady=15)
        ...
        ctk.CTkButton(botones_frame, text="Crear Empleado", command=self.obtener_seleccion).grid(row=0, column=2, padx=10)
