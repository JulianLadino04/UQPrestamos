...
class gestionar_pagos_empleado:
    def __init__(self):
        ...
        ctk.CTkLabel(master=self.root, text="Vista de pagos de Empleado", font=("Roboto", 36)).pack(pady=15)
        ...
        ctk.CTkButton(botones_frame, text="Crear Pago", command=self.obtener_seleccion).grid(row=0, column=2, padx=10)
